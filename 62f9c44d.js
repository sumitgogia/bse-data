...
const {
  ...
  c$2 = (o, i, n) => {
    ...
    if (void 0 === n) {
      const i = v.insertBefore(r$1(), d),
        t = v.insertBefore(r$1(), d);
      n = new l$2(i, t, o, o.options);
    } else {
...
function h$1(i, t = !1, e = 0) {
  ...
  if (void 0 !== n && 0 !== n.size) if (t) {
    if (Array.isArray(r)) for (let i = e; i < r.length; i++) s$1(r[i], !1), o$2(r[i]);else null != r && (s$1(r, !1), o$2(r));
  } else s$1(this, i);
}
const l$1 = i => {
  var t, s, o, r;
...
class c$1 extends i$1 {
  ...
  _$AO(i, t = !0) {
    var e, r;
    i !== this.isConnected && (this.isConnected = i, i ? null === (e = this.reconnected) || void 0 === e || e.call(this) : null === (r = this.disconnected) || void 0 === r || r.call(this)), t && (s$1(this, i), o$2(this));
  }
  setValue(t) {
...
const h = new WeakMap(),
  n$2 = e$3(class extends c$1 {
    ...
    update(t, [s]) {
      var e;
      const o = s !== this.G;
      return o && void 0 !== this.G && this.ot(void 0), (o || this.rt !== this.lt) && (this.G = s, this.dt = null === (e = t.options) || void 0 === e ? void 0 : e.host, this.ot(this.lt = t.element)), A;
    }
    ot(i) {
      var t;
  ...
  switch (path) {
    ...
    default:
      return new Promise(function (resolve, reject) {
        (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(reject.bind(null, new Error("Unknown variable dynamic new URL statement: " + path)));
      });
  }
}
...
let BookmarkValueComponent = BookmarkValueComponent_1 = class BookmarkValueComponent2 extends BaseView {
  ...
  set name(name) {
    if (this._savedValuesKey) {
      this.localStorageService.removeItem(this._savedValuesKey);
    }
    this._name = name;
    this._savedValuesKey = name ? `[bookmark-value][${name}]/savedValues` : void 0;
  }
  get name() {
    return this._name;
  }
  ...
  set _savedValues(sv) {
    ...
    if (this._savedValuesKey) {
      this.localStorageService.setItem(this._savedValuesKey, sv);
    }
    this.requestUpdate();
  }
  get _savedValues() {
    return this.__savedValues;
  }
  firstUpdated() {
    const examplesFile = __variableDynamicURLRuntime0__(`../../../../assets/json/${this.name}-examples.json`).href;
    fetch(examplesFile).then(r => {
      if (!r.ok) {
  ...
  isValueSaved() {
    return !!this.value && this._savedValues.some(sv => sv.value === this.value);
  }
  toggleSave() {
    const {
      value
    ...
    if (this.isValueSaved()) {
      ...
      this._savedValues = [...this._savedValues, sv];
    }
  }
  render() {
    return x`
      <style>
        ${BookmarkValueComponent_1.styles.cssText}
      </style>
      <div class="btn-group position-static">
        ${this.allowClear ? x` <button @click="${this.onSavedValueSelection}" type="button" class="btn btn-light border-secondary-subtle rounded-start-0" title="Clear search"> <i class="bi bi-x"></i> </button> ` : A$1}
        <button
        ...
        <button
          type="button"
          class="btn btn-light border-secondary-subtle dropdown-toggle dropdown-toggle-split"
  ...
  savedValueTemplate(sv) {
    var _a, _b, _c, _d;
    return this.editMode ? x` <li class="d-flex align-items-center my-2 gap-2"> <button class="btn col-auto" @click="${e => {
      e.stopPropagation();
      this.removeSavedValue(sv.value);
      if (!this._savedValues.length) {
        this.editMode = false;
      }
    }}"> <i class="bi bi-trash"></i> </button> <div class="form-floating col-auto"> <input @change="${e => {
      e.preventDefault();
      e.stopPropagation();
  ...
  onSavedValueSelection(e, sv) {
    var _a;
    const currentValue = this.value;
    const newValue = (_a = sv === null || sv === void 0 ? void 0 : sv.value) !== null && _a !== void 0 ? _a : "";
    if (newValue !== currentValue) {
      this.dispatchEvent(new CustomEvent("select.bv", {
        bubbles: true,
        composed: true,
        detail: {
          value: newValue
...
__decorate([n$4({
  type: Boolean
})], BookmarkValueComponent.prototype, "editMode", void 0);
__decorate([n$4()], BookmarkValueComponent.prototype, "defaultGroup", void 0);
__decorate([t()], BookmarkValueComponent.prototype, "_exampleValues", void 0);
__decorate([t()], BookmarkValueComponent.prototype, "_savedValues", null);
BookmarkValueComponent = BookmarkValueComponent_1 = __decorate([e$4("bookmark-value")], BookmarkValueComponent);

function notifyUser(message) {
  return function (target, propertyKey, descriptor) {
    const originalMethod = descriptor.value;
    descriptor.value = async function (...args) {
      const startEvent = new CustomEvent(DtfEvent.LONG_TASK_START, {
        detail: {
          message
        },
        bubbles: true,
      ...
      try {
        ...
        const endEvent = new CustomEvent(DtfEvent.LONG_TASK_FINISH, {
          detail: {
            message,
            error
          },
 ...
 */
const e = {},
  i = e$3(class extends i$1 {
    constructor() {
      super(...arguments), this.st = e;
    }
    render(r, t) {
      return t();
    }
    update(t, [s, e]) {
      if (Array.isArray(s)) {
        if (Array.isArray(this.st) && this.st.length === s.length && s.every((r, t) => r === this.st[t])) return T;
      } else if (this.st === s) return T;
      return this.st = Array.isArray(s) ? Array.from(s) : s, this.render(s, e);
    }
  });

var CompanySelectorComponent_1;
let CompanySelectorComponent = CompanySelectorComponent_1 = class CompanySelectorComponent2 extends BaseView {
  constructor() {
    super(...arguments);
    this.selected = [];
    this._companyFilterRef = e$1();
    this._companyBookmarkRef = e$1();
  }
  firstUpdated(changedProperties) {
    super.firstUpdated(changedProperties);
    jQuery.ready.then(() => {
      this.initCompaniesSelect();
    });
  }
  async updated(changedProperties) {
    if (changedProperties.has("selected")) {
      await this.updateComplete;
      this.setSelectedData(this.selected);
    }
  }
  render() {
    return x`
      <style>
        ${CompanySelectorComponent_1.styles.cssText}
      </style>
      <div class="input-group">
        <div class="form-floating">
          <select
            ${n$2(this._companyFilterRef)}
            placeholder="Select Companies"
            class="form-select data-filter companies"
      ...
      return c(Object.entries((_a = this.companyNamesByCode) !== null && _a !== void 0 ? _a : {}).sort((o1, o2) => o1[1] > o2[1] ? 1 : -1), ([code]) => code, ([code, name]) => x` <option value="${code}">${name}</option> `);
          ...
          <label for="companies-filter">Companies</label>
        </div>
        ${i([this.name], () => this.name ? x` <bookmark-value ${n$2(this._companyBookmarkRef)} @select.bv="${e => {
      this.setSelected(e.detail.value);
    }}" name="${this.name}" defaultGroup="My Companies" class="btn-toolbar" allowClear></bookmark-value> ` : A$1)}
      </div>
      <div class="form-check form-switch mt-1">
        <input
          @change="${this._handleAllCompanySwitch}"
          class="form-check-input"
          type="checkbox"
          role="switch"
          name="all-companies-switch"
          aria-checked="false"
        />
        <label class="form-check-label fst-italic" for="all-companies-switch"
          ><small>Show all companies</small></label
        >
      </div>
    `;
  }
  initCompaniesSelect() {
    const companySelectElement = this._companyFilterRef.value;
    ...
    jQuery(companySelectElement).select2({
      ...
      width: "100%",
      theme: "bootstrap-5",
      templateResult: data => jQuery(`<span class="${this._allCompanies && (!this.companyNamesByCode || !this.companyNamesByCode[data.id]) ? "text-body-tertiary" : ""}">${data.text}</span>`),
      matcher: (params, data) => {
        var _a;
        const tokens = Utils.tokenize((_a = params.term) !== null && _a !== void 0 ? _a : "");
        const terms = tokens.filter(t => !t.tag).map(t => t.term);
        if (!terms.length) {
          return data;
        }
        const dataText = data.text.toLowerCase();
        return terms.some(t => dataText.indexOf(t.toLowerCase()) > -1) ? data : null;
      },
      tags: true,
      createTag: params => {
        var _a, _b;
        const term = (_b = (_a = params.term) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
        if (term === "" || !companySqlRegex.test(term)) {
          return null;
        }
        return {
          id: term,
      ...
      const companyBookmarkComponent = this._companyBookmarkRef.value;
      if (companyBookmarkComponent) {
        companyBookmarkComponent.value = serializable.join(",");
      }
      this.dispatchEvent(new CustomEvent("selected.cs", {
        bubbles: true,
        composed: true,
        detail: {
          selected,
      ...
      jQuery(companySelectElement).on("select2:opening.cancelOpen", evt => {
        evt.preventDefault();
        jQuery(companySelectElement).off("select2:opening.cancelOpen");
      });
    });
  }
  ...
  readSelectedData() {
    const companySelectElement = this._companyFilterRef.value;
    const selectedData = jQuery(companySelectElement).select2("data");
    const selected = [];
    const conditions = [];
    const serializable = [];
    selectedData.forEach(v => {
      var _a;
      if (((_a = v.id) === null || _a === void 0 ? void 0 : _a.trim()) === "") {
        return;
      }
      if (Number(v.id)) {
        selected.push(v.id);
      } else {
        const match = v.id.match(/c:"(.*)"/);
        if (match) {
  ...
  setSelected(bookmarkedValue) {
    const selected = [];
    const conditions = [];
    bookmarkedValue.split(",").forEach(v => {
      if (v.trim() === "") {
        return;
      }
...
CompanySelectorComponent.styles = i$2`.select2-container .select2-selection--multiple{max-height:120px;overflow-y:auto;min-height:calc(2.5em + 1rem + 2px);padding-top:1.5em}.select2-selection .select2-search{display:block}.select2-selection textarea.select2-search__field{text-align:inherit!important}.select2-container--bootstrap-5 .select2-selection--multiple .select2-selection__clear{right:2.25rem}.select2-container--bootstrap-5 .select2-selection--multiple .select2-selection__rendered .select2-selection__choice{border-radius:var(--bs-border-radius-pill)!important}`;
__decorate([c$3({
  context: loggerContext
})], CompanySelectorComponent.prototype, "logger", void 0);
__decorate([n$4()], CompanySelectorComponent.prototype, "name", void 0);
__decorate([n$4({
  attribute: false
})], CompanySelectorComponent.prototype, "companyNamesByCode", void 0);
__decorate([n$4({
  type: Array
})], CompanySelectorComponent.prototype, "selected", void 0);
__decorate([t()], CompanySelectorComponent.prototype, "_allCompanies", void 0);
CompanySelectorComponent = CompanySelectorComponent_1 = __decorate([e$4("company-selector")], CompanySelectorComponent);

var AnnouncementView_1;
let AnnouncementView = AnnouncementView_1 = class AnnouncementView2 extends BaseView {
  constructor() {
    super(...arguments);
    this._searchBoxRef = e$1();
    this._searchBookmarkRef = e$1();
    this._selectedCompanies = [];
    this.sEmptyTableWhenFetching = `<span
      class="spinner-border spinner-border-sm text-secondary"
      aria-hidden="true"
    ></span>
    <i role="status">Fetching Announcements...</i>`;
    this.companytag = "c";
    this.lastProcessedDate = /* @__PURE__ */new Date();
  }
  firstUpdated(changedProperties) {
    super.firstUpdated(changedProperties);
    jQuery.ready.then(() => {
  ...
  render() {
    return x`
      <style>
        ${AnnouncementView_1.styles.cssText}
      </style>
      ${this.headerTemplate} ${this.announcementsDatatable}
    `;
  }
  get headerTemplate() {
    return x` <header class="container-fluid my-2"> <div class="row gap-2 gap-md-0"> <div class="col-md-4">${this.dateRangeSelectorTemplate}</div> <div class="col-md-4">${this.companySelectorTemplate}</div> <div class="col-md-4 dataTable-filter">${this.searchBoxTemplate}</div> </div> </header> `;
  }
  // eslint-disable-next-line class-methods-use-this
  get dateRangeSelectorTemplate() {
    return x` <div class="form-floating"> <input type="text" class="form-control data-filter dates" name="dates-selector" placeholder="Date range" title="Announcements for selected date ranges are shown"> <label for="dates-selector">Date Range</label> </div> <div class="fst-italic"> <small> <i class="bi bi-info-circle"></i> <span>Changing date range will clear all other filters</span> </small> </div> `;
  }
  get companySelectorTemplate() {
    return x` <company-selector name="announcements-company-filter" .companyNamesByCode="${this._companyNamesByCode}" .selected="${this._selectedCompanies}" @selected.cs="${this.onCompanySelection}"></company-selector> `;
  }
  get searchBoxTemplate() {
    return x` <div class="input-group"> <div class="form-floating"> <input ${n$2(this._searchBoxRef)} @input="${jQuery.fn.dataTable.util.throttle(e => {
      var _a, _b;
      this.customSearch(e);
      const bookmarkValueComponent = this._searchBookmarkRef.value;
      if (!bookmarkValueComponent) {
        return;
      }
      bookmarkValueComponent.value = (_b = (_a = this._searchBoxRef.value) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : "";
    }, 1e3)}" type="text" class="form-control data-filter search" name="dataTable-search" placeholder="Search" title="Search announcements" aria-label="Search announcements"> <label for="dataTable-search">Search</label> </div> <bookmark-value ${n$2(this._searchBookmarkRef)} @select.bv="${e => this.setSearchBoxValue(e.detail.value)}" name="announcements-search-box" defaultGroup="My Searches" class="btn-toolbar" allowClear></bookmark-value> </div> `;
  }
  // eslint-disable-next-line class-methods-use-this
  ...
  createDataTable(headers, data) {
    ...
    const dataTable = jQuery(sDataTable).DataTable({
      ...
      searchDelay: 1e3,
      language: {
        emptyTable: "No announcements! Pick a different date range.",
    ...
    jQuery("#dataTable_filter").detach();
    dataTable.on("search.dt", () => {
      const q = dataTable.search();
      if (q.length > 3) {
        analytics.track("announcement_search", {
          query: q
        });
      }
      const cq = dataTable.column(AnnouncementView_1.companyCodeColumnIndex).search();
      if (cq.length) {
        cq.split("|").forEach(c => {
          analytics.track("company_filter", {
            company: c.slice(1, -1)
          });
        });
      }
  ...
  async updateDatatable() {
    ...
    let oLanguage;
    if (this.dataTable) {
      oLanguage = this.dataTable.settings()[0].oLanguage;
      sEmptyTable = oLanguage.sEmptyTable;
      oLanguage.sEmptyTable = this.sEmptyTableWhenFetching;
      this.dataTable.clear().draw();
    }
    try {
      announcements = await announcementService.announcements(filters);
    } catch (error) {
    ...
    const tableData = announcements[0].values;
    if (this.dataTable) {
      this.dataTable.rows.add(tableData).column(AnnouncementView_1.companyCodeColumnIndex).search("").column(AnnouncementView_1.companyNameColumnIndex).search("").draw();
      this._selectedCompanies = [];
      this.setSearchBoxValue("");
    } else {
      this.dataTable = this.createDataTable(tableHeaders, tableData);
    }
    const companyCodesAndNames = this.dataTable.columns([AnnouncementView_1.companyCodeColumnIndex, AnnouncementView_1.companyNameColumnIndex]).cache("search");
    const companyNamesByCode = {};
    companyCodesAndNames[0].forEach((code, i) => {
      companyNamesByCode[code] = companyCodesAndNames[1][i];
    });
    this._companyNamesByCode = companyNamesByCode;
  }
  initDatepicker() {
    var _a;
    const drpSelector = "input.data-filter.dates";
    const drpElement = this.querySelector(drpSelector);
    if (!drpElement) {
      return;
    }
    ...
    drp.on("apply.daterangepicker", (ev, picker) => {
      picker.element.attr("size", picker.element.val().length);
      this.updateDatatable();
    });
    $drp.attr("size", (_a = $drp.val()) === null || _a === void 0 ? void 0 : _a.length).trigger("apply.daterangepicker", $drp.data("daterangepicker"));
  }
  ...
  async onCompanySelection(e) {
    ...
    if (conditions.length) {
      ...
      try {
        ...
        selected.push(...cCodes);
        selected = [...new Set(selected)];
      } catch (error) {
        this.logger.debug("Error", error);
      }
    }
    const searchText = selected.join("|");
    this.dataTable.column(AnnouncementView_1.companyCodeColumnIndex).search(searchText, true, false).draw();
  }
  setSearchBoxValue(value) {
    const searchBox = this._searchBoxRef.value;
    if (!searchBox) {
      return;
    }
...
__decorate([t()], AnnouncementView.prototype, "_companyNamesByCode", void 0);
__decorate([t()], AnnouncementView.prototype, "_selectedCompanies", void 0);
__decorate([notifyUser("Fetch announcements and update view")], AnnouncementView.prototype, "updateDatatable", null);
AnnouncementView = AnnouncementView_1 = __decorate([e$4("announcements-view")], AnnouncementView);
